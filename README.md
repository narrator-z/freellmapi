...
- **Model profiles** — save named fallback-chain configurations (a coding chain, a long-context chain, a vision chain), switch the active one from the dashboard, and rename custom chains in place from the chain manager.
