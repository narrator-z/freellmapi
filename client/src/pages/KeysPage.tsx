...
const PLATFORMS: { value: Platform; label: string; url: string; keyless?: boolean }[] = [
  ...
  { value: 'clawbrain', label: 'ClawBrain', url: 'https://www.clawbrain.dev/dashboard' },
  ...
  { value: 'lepton', label: 'Lepton AI', url: 'https://lepton.ai' },
  ...
  { value: 'nebius', label: 'Nebius AI Studio', url: 'https://tokenfactory.nebius.com/project/api-keys' },
