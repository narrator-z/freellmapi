...
const PLATFORMS: { value: Platform; label: string; url: string; keyless?: boolean }[] = [
  ...
  { value: 'aimlapi', label: 'AI/ML API', url: 'https://aimlapi.com' },
  { value: 'ai21-labs', label: 'AI21 Labs', url: 'https://www.ai21.com/studio' },
  { value: 'anyscale', label: 'Anyscale', url: 'https://anyscale.com' },
  { value: 'awanllm', label: 'AwanLLM', url: 'https://awanllm.com' },
  { value: 'baichuan', label: 'Baichuan AI', url: 'https://www.baichuan-ai.com' },
  { value: 'cerebras-cloud', label: 'Cerebras Cloud', url: 'https://cloud.cerebras.ai' },
  { value: 'clawbrain', label: 'ClawBrain', url: 'https://www.clawbrain.dev' },
  { value: 'cloudflare-workers-ai', label: 'Cloudflare Workers AI', url: 'https://ai.cloudflare.com' },
  { value: 'deepinfra', label: 'DeepInfra', url: 'https://deepinfra.com' },
  { value: 'deepseek', label: 'DeepSeek', url: 'https://platform.deepseek.com' },
  { value: 'doubao', label: 'Doubao (ByteDance)', url: 'https://www.doubao.com' },
  { value: 'ernie', label: 'ERNIE Bot (Baidu)', url: 'https://yiyan.baidu.com' },
  { value: 'fireworks', label: 'Fireworks AI', url: 'https://fireworks.ai' },
  { value: 'fireworks-ai', label: 'Fireworks AI (yangmao)', url: 'https://fireworks.ai' },
  { value: 'grok', label: 'Grok (xAI)', url: 'https://grok.x.ai' },
  { value: 'kimi', label: 'Kimi (Moonshot AI)', url: 'https://kimi.moonshot.cn' },
  { value: 'lepton', label: 'DGX Cloud Lepton', url: 'https://build.nvidia.com/explore/discover' },
  { value: 'llama-cpp', label: 'llama.cpp (local)', url: '' },
  { value: 'lmstudio', label: 'LM Studio (local)', url: '' },
  { value: 'localai', label: 'LocalAI (local)', url: '' },
  { value: 'minimax', label: 'MiniMax', url: 'https://www.minimaxi.com' },
  { value: 'monsterapi', label: 'MonsterAPI', url: 'https://monsterapi.ai' },
  { value: 'nebius', label: 'Nebius AI Studio', url: 'https://studio.nebius.com' },
  { value: 'novita', label: 'Novita AI', url: 'https://novita.ai' },
  { value: 'nvidia-build', label: 'NVIDIA Build (NIM API)', url: 'https://build.nvidia.com' },
  { value: 'octoai', label: 'OctoAI', url: 'https://octo.ai' },
  { value: 'openpipe', label: 'OpenPipe', url: 'https://openpipe.ai' },
  { value: 'parasail', label: 'Parasail', url: 'https://www.parasail.io' },
  { value: 'portkey-ai', label: 'Portkey AI', url: 'https://portkey.ai' },
  { value: 'qwen', label: 'Qwen (Alibaba Cloud)', url: 'https://tongyi.aliyun.com' },
  { value: 'runpod', label: 'RunPod', url: 'https://www.runpod.io' },
  { value: 'sambanova', label: 'SambaNova', url: 'https://sambanova.ai' },
  { value: 'stepfun', label: 'StepFun (StepStar)', url: 'https://platform.stepfun.com' },
  { value: 'together-ai', label: 'Together AI', url: 'https://together.ai' },
]
